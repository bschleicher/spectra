...
class Spectrum:
    ...
    def calc_differential_spectrum(self,
        ...
        if filename is not None:
            ...
            np.savetxt(filename+'EffectiveArea.txt', (np.vstack((bin_centers,self.effective_area,bin_error,self.effective_area_err)).T),header='bin_centers EffectiveError, bin_error, scaledEffectiveAreaErr')
